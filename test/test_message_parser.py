...
class MessageParserTestCase(unittest.TestCase):
    ...
    def test_identity_request_message_packs(self):
        ...
        packed_message = MessagePacker.ethernet_pack(message, MacAddress.from_string("00:19:06:ea:b8:8c"), MacAddress.from_string("01:80:c2:00:00:03"))
    ...
    def test_identity_response_message_packs(self):
        ...
        packed_message = MessagePacker.ethernet_pack(message, MacAddress.from_string("00:14:22:e9:54:5e"), MacAddress.from_string("01:80:c2:00:00:03"))
        self.assertEqual(expected_packed_message, packed_message)
    ...
    def test_failure_message_packs(self):
        ...
        packed_message = MessagePacker.ethernet_pack(message, MacAddress.from_string("00:19:06:ea:b8:8c"), MacAddress.from_string("00:00:00:00:00:01"))
        self.assertEqual(expected_packed_message, packed_message)
