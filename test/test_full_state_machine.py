...
class FullStateMachineStartTestCase(unittest.TestCase):
    ...
    def test_eap_start(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.IDLE)
    ...
    def test_timeout_failure_from_max_retransmits(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.TIMEOUT_FAILURE)
    ...
    def test_leave_timeout_failure2_with_identiy_response(self):
        ...
        self.sm.event(EventMessageReceived(message, None))
        self.assertEqual(self.sm.current_state, self.sm.AAA_IDLE)
    ...
    def test_timeout_failure2_from_aaa_timeout(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.TIMEOUT_FAILURE2)
    ...
    def test_disabled_state(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.DISABLED)
    ...
    def test_md5_challenge_request(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.IDLE2)
    ...
    def test_success2(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.SUCCESS2)
        self.assertEqual(self.eap_output_queue.qsize(), 1)
    ...
    def test_logoff2(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.LOGOFF2)
        self.assertEqual(self.eap_output_queue.qsize(), 0)
        self.assertEqual(self.radius_output_queue.qsize(), 0)
    ...
    def test_failure2(self):
        ...
        self.assertEqual(self.sm.current_state, self.sm.FAILURE2)
        self.assertEqual(self.eap_output_queue.qsize(), 1)
