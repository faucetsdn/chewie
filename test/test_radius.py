...
class RadiusTestCase(unittest.TestCase):
    ...
    def test_response_authenticator(self):
        packet = bytes.fromhex("")
        secret = "testing1234"
        request_authenticator_callback = lambda x: bytes.fromhex('1068a828fe678c6be23ea9580a2df071')
        Radius.parse(packet, secret, request_authenticator_callback=request_authenticator_callback)
