...
class RadiusTestCase(unittest.TestCase):
    def test_radius_access_request_parses(self):
        ...
        message = Radius.parse(packed_message, secret="SECRET", request_authenticator_callback=lambda x: None)
    ...
    def test_corrupted_packets(self):
        ...
        self.assertRaises(InvalidResponseAuthenticatorError, Radius.parse, packed_message, secret="SECRET",
